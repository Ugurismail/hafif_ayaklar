...
def logic_stage_c_preview(request, *args, **kwargs):
    from core.views.logic_views import logic_stage_c_preview as view
    return view(request, *args, **kwargs)


def logic_stage_d_preview(request, *args, **kwargs):
    from core.views.logic_views import logic_stage_d_preview as view
    return view(request, *args, **kwargs)


def logic_stage_e_preview(request, *args, **kwargs):
    from core.views.logic_views import logic_stage_e_preview as view
    return view(request, *args, **kwargs)


def logic_stage_f_preview(request, *args, **kwargs):
    from core.views.logic_views import logic_stage_f_preview as view
    return view(request, *args, **kwargs)
...
urlpatterns = [
    ...
    path('mantik/inceleme/faz-3c/', logic_stage_c_preview, name='logic_stage_c_preview'),
