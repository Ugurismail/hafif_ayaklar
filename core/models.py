...
class UserProfile(models.Model):
    ...
    background_color = models.CharField(max_length=7, default='#F5F0E6') #genel arka plan
    text_color = models.CharField(max_length=7, default='#1F1A14')
    message_bubble_color = models.CharField(max_length=7, default='#DCE8DE')
    tbas_color=models.CharField(max_length=7, default='#1F1A14')

    yanit_card = models.CharField(max_length=7, default='#FFF9F0')
    header_background_color = models.CharField(max_length=7, default='#22312B')
    header_text_color = models.CharField(max_length=7, default='#F7F2E8')
    link_color = models.CharField(max_length=7, default='#2F6B4F')
    link_hover_color = models.CharField(max_length=7, default='#1E4D38')

    button_background_color = models.CharField(max_length=7, default='#B08D57')
    button_hover_background_color = models.CharField(max_length=7, default='#9A7747')
    button_text_color = models.CharField(max_length=7, default='#FAF7F0')

    secondary_button_background_color = models.CharField(max_length=7, default='#2E3A2F')
    secondary_button_hover_background_color = models.CharField(max_length=7, default='#243028')
    secondary_button_text_color = models.CharField(max_length=7, default='#F7F2E8')

    font_size = models.IntegerField(default=18)

    hover_background_color = models.CharField(max_length=7, default='#E7DFD2')
    icon_color = models.CharField(max_length=7, default='#22312B')
    icon_hover_color = models.CharField(max_length=7, default='#B08D57')
    answer_background_color = models.CharField(max_length=7, default='#F5F0E6')
    content_background_color = models.CharField(max_length=7, default='#FFF9F0')
    tab_background_color = models.CharField(max_length=7, default='#EFE6D8')
    tab_text_color = models.CharField(max_length=7, default='#1F1A14')
    tab_active_background_color = models.CharField(max_length=7, default='#FFF9F0')
    tab_active_text_color = models.CharField(max_length=7, default='#22312B')
    dropdown_text_color = models.CharField(max_length=7, default='#1F1A14')
    dropdown_hover_background_color = models.CharField(max_length=7, default='#E7DFD2')
    dropdown_hover_text_color = models.CharField(max_length=7, default='#22312B')
    nav_link_hover_color = models.CharField(max_length=7, default='#FAF7F0')

    nav_link_hover_bg = models.CharField(max_length=7, default='#2B3D35')

    pagination_background_color = models.CharField(max_length=7, default='#FFF9F0')
    pagination_text_color = models.CharField(max_length=7, default='#22312B')
    ...
    font_family = models.CharField(max_length=100, default='Crimson+Text')
...
class Notification(models.Model):
    ...
    @classmethod
    def create_new_follower_notification(cls, recipient, follower):
        """Create notification when someone follows you"""
        message = f"{follower.username} seni takip etmeye başladı"
        return cls.objects.create(
            recipient=recipient,
            sender=follower,
