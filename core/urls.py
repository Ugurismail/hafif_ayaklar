...
urlpatterns = [
    ...
    *(
    ...
    path('yazar/<int:user_id>/', public_author, name='public_author'),
    ...
    path('duzeltmeler/', correction_inbox, name='correction_inbox'),
    ...
    path('navbar/status/', navbar_status, name='navbar_status'),
    ...
    path('devam-cetveli/day-state/', attendance_day_state, name='attendance_sheet_day_state'),
    path('devam-cetveli/leave-range/', attendance_leave_range, name='attendance_sheet_leave_range'),
    path('devam-cetveli/save/', attendance_save_state, name='attendance_sheet_save'),
    ...
    path('reference/<int:reference_id>/usages/', reference_usage_data, name='reference_usage_data'),
